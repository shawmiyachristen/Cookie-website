    ...
    <div className="min-h-screen selection:bg-brand-primary selection:text-white">
          ...
          {[
            {
              ...
              price: "$2.99",
              tag: "Gourmet Cookie",
              img: "/src/assets/images/regenerated_image_1778055767487.jpg"
            },
            {
              title: "Chocolate Chip Walnuts",
              price: "$2.99",
              tag: "Nutty Cookie",
              img: "/src/assets/images/regenerated_image_1778055765989.jpg"
            },
            {
              title: "Caramel Chocolate Chip",
              price: "$2.99",
              tag: "Indulgent",
              img: "/src/assets/images/regenerated_image_1778055769342.jpg"
            }
          ].map((item, idx) => (
      ...
      <section className="bg-brand-container py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 items-center gap-12 md:gap-24">
          ...
          >
            <img 
              src="/src/assets/images/regenerated_image_1778056492276.jpg"
          ...
          <motion.div {...fadeIn}>
            ...
            <div className="p-6 bg-brand-surface rounded-3xl shadow-sm flex items-center gap-6 mb-10 group">
              <div className="w-24 h-24 rounded-2xl overflow-hidden shrink-0">
                <img 
                  src="/src/assets/images/regenerated_image_1778055767487.jpg"
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
          <GalleryItem delay={0} src="/src/assets/images/regenerated_image_1778056489712.jpg" />
          <GalleryItem delay={0.1} span src="/src/assets/images/regenerated_image_1778056483112.jpg" />
          <GalleryItem delay={0.2} src="/src/assets/images/regenerated_image_1778056488391.jpg" />
          <GalleryItem delay={0.3} src="/src/assets/images/regenerated_image_1778056484423.jpg" />
          <GalleryItem delay={0.4} src="/src/assets/images/regenerated_image_1778056485724.jpg" />
          <GalleryItem delay={0.5} src="/src/assets/images/regenerated_image_1778056487054.jpg" />
        </div>
      </section>
